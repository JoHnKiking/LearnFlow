  ...
  return (
    <View style={[styles.container, { width: size, height: size }]}>
      <Svg width={size} height={size} viewBox="0 0 100 100">
        {type === 'lively' && <LivelyMonster p={p} s={s} h={h} />}
        {type === 'calm' && <CalmMonster p={p} s={s} h={h} />}
        {type === 'rebel' && <RebelMonster p={p} s={s} h={h} />}
      </Svg>
    </View>
  );
};
