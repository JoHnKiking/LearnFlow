...
const subSectionH = { fontSize: 14, fontWeight: '700' as const, marginBottom: 6, marginTop: 12 };
...
export const PRIVACY_POLICY_CONTENT = () => (
  <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 20 }}>
    ...
    <Text style={bullet}>• 箱地址：用于账号注册、登录、身份验证、账号找回及服务通知；</Text>
    ...
    <Text style={bullet}>• 联系邮箱：johnkiking@foxmail.com</Text>
